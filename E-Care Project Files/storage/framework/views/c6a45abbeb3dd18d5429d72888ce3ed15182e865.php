                        ...
                        <h4>Change Account Password</h4>
                           ...
                           <form role="form" action="/admin/profile/password" method="POST" style="padding-left:15%;padding-top:3%;">
                               ...
                               <div class="form-group row">
                                   <label class="col-md-3 col-form-label form-control-label">New Password</label>
                                   <div class="col-md-5">
                                      <input class="form-control  <?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>"  name="password" type="password" id="newpassword"autofocus>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label form-control-label text-danger font-weight-bold">Account Password</label>
                                    <div class="col-md-5">
                                        <input class="form-control <?php echo e($errors->has('oldpassword') ? ' is-invalid' : ''); ?>" name="oldpassword" type="password">
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/admin/profile/password.blade.php ENDPATH**/ ?>