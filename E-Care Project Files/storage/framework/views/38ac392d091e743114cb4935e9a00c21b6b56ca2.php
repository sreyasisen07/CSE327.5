...
<?php $__env->startSection('pagetitle', 'Pickup Requests'); ?>
     ...
     <div id="content">
      ...
      <div class="card Poppins">
        ...
        <div class="card Poppins mb-4">
          <div class="card-header font-weight-bold">
            <div class="row justify-content-center">
            <span class=" mdb-color-text font-weight-bold small">Request time : <?php echo e($shipment->created_at); ?></span>
            </div>
          ...
          <div class="card-body branch_add">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-4">
                ...
                <div class="small">
                <span class="font-weight-bold"> Name : </span><span><?php echo e($shipment->sender_name); ?></span><br>
                <span class="font-weight-bold"> Phone : </span><span><?php echo e($shipment->sender_phone); ?></span><br>
                <span class="font-weight-bold"> Address : </span><span><?php echo e($shipment->sender_address); ?></span>
                <hr>
                </div>
              </div>
              <div class="col-md-4">
                ...
                <div class="small">
                  <span class="font-weight-bold"> Name : </span><span><?php echo e($shipment->recipient_name); ?></span><br>
                  <span class="font-weight-bold"> Phone : </span><span><?php echo e($shipment->recipient_phone); ?></span><br>
                  <span class="font-weight-bold"> Address : </span><span><?php echo e($shipment->recipient_address); ?></span>
                  <hr>
                  </div>
              </div>
              <div class="col-md-4">
            ...
            <div class="row mb-4">
              <div class="col-md-4">
                   ...
                   <span class="h5 raleway">Charge : </span><span class="h5 font-weight-bold mdb-color-text"> &nbsp;<?php echo e($shipment->amount); ?>৳</span>
              ...
              <div class="col-md-8">  
                    ...
                    <div class="row">
                      <div class="col-md-6" style="margin-top:6px;">
                        <select class=" form-control form-control-sm  <?php $__errorArgs = ['branch'];
...
unset($__errorArgs, $__bag); ?>" name="branch" id="branch">
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Parcel-Manager\resources\views/admin/shipment/request.blade.php ENDPATH**/ ?>