...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid py-4" style="background:white!important;">
        ...
        <div class="row justify-content-center">
            <img style="max-width:50%" src="<?php echo e(asset('img/process.png')); ?>" alt="">
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Parcel-Manager\resources\views/pages/services.blade.php ENDPATH**/ ?>