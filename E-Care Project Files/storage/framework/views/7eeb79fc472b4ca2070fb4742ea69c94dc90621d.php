...
<head>
    ...
    <title><?php echo e(config('app.name', 'E-Care')); ?> | Page Not Found</title>
    ...
    <div id="app">
            ...
            <div class="container Error404 py-4">
                <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center" style="margin-top:10%">
                        <img class="mb-4" src="<?php echo e(asset('img/404.png')); ?>" alt="">
                    </div>
                </div>
                <h1 class="text-center raleway mb-4 text-secondary">PAGE NOT FOUND</h1>
                <div class="row justify-content-center">
                    <button onclick="goBack()" class="btn btn-unique"><i class="fas fa-chevron-circle-left"></i> GO
                        BACK</button>
                    <button onclick="window.location.href='/'" class="btn btn-mdb-color"><i class="fas fa-home"></i>
                        HOME</button>
                </div>
            </div>
        </main>
        ...
        <footer class="page-footer font-small mdb-color">
            ...
            <div class="footer-copyright text-center py-3">
                <div class="row justify-content-center">
                    <img class="footer-logo" src="<?php echo e(asset('img/logo.png')); ?>" alt="">
...
<?php /**PATH C:\xampp\htdocs\E-Care\resources\views/errors/404.blade.php ENDPATH**/ ?>