                            ...
                            <div class="card-body" style="padding-top:5%;padding-left:10%;padding-right:10%;">
                                <div class="row mb-4">
                                    <div class="col-md-10">
                                        <img style="max-width:20%!important;text-align:left;"
                                            src="<?php echo e(asset('img/logo.png')); ?>" alt="">
                                    </div>
                                    <div class="col-md-2 small">
                                        <span>Appointment ID :</span><span class="mdb-color-text"
                                            style="font-weight:bold;"> &nbsp;10112<?php echo e($appointment->id); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center mb-4">
                                    ...
                                    <span style="background-color:#c8e6c9; color:#1b5e20;padding:0.5%;"
                                        class="font-weight-bold h4"><?php echo e($appointment->status); ?></span>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/admin/appointment/status.blade.php ENDPATH**/ ?>