...
<?php $__env->startSection('pagetitle', 'Account'); ?>
        ...
        <!-- Begin Page Content -->
                ...
                <div class="container">
                    <div class="counter">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-3">
                                <div class="count-data text-center">
                                <h6 class="count h5" data-to=<?php echo e($completed); ?> data-speed=<?php echo e($completed); ?>><?php echo e($completed); ?></h6>
                                    <p class="m-0px font-w-600">Completed</p>
                                </div>
                            </div>
                            <div class="col-6 col-lg-3">
                                <div class="count-data text-center">
                                <h6 class="count h5" data-to="190" data-speed="190"><?php echo e($pending); ?></h6>
                            ...
                            <div class="card gradient-card">
                               ...
                               <div class="blue-grey-text d-flex h-100 mask cloudy-knoxville-gradient">
                                   <div class="first-content align-self-center p-3" style="padding-left:10%!important;">
                                       ...
                                       <h5 class="lead mb-0 font-weight-bold"><?php echo e(Auth::guard('admin')->user()->name); ?></h5>
                                    </div>
                             ...
                             <div class="card gradient-card">
                                 ...
                                 <div class="blue-grey-text d-flex h-100 mask cloudy-knoxville-gradient">
                                     <div class="first-content align-self-center p-3"style="padding-left:10%!important;">
                                          ...
                                          <h5 class="lead mb-0 font-weight-bold"><?php echo e(Auth::guard('admin')->user()->email); ?></h5>
                                     </div>
                                     <div class="second-content align-self-center mx-auto text-center">
            ...
            <?php if(session('error')): ?>
              <div style="margin-left:10%;margin-right:10%;" class="alert alert-danger alert-dismissible fade show text-center font-weight-bold small" role="alert">
                  <?php echo e(session('error')); ?>&nbsp; <i class="fas fa-exclamation-triangle"></i>
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
              </div>
                      ...
                      <div class="card-body">
                           <form role="form" action="/admin/profile/view" method="POST" style="padding-left:15%;padding-top:3%;">
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-lg-6">
                                      <input class="form-control  <?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" value="<?php echo e(Auth::guard('admin')->user()->name); ?>" name="name" type="text">
                                ...
                                <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">             
                                        <input class="form-control  <?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email" type="email" value= <?php echo e(Auth::guard('admin')->user()->email); ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input class="form-control <?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" name="password" type="password">
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Parcel-Manager\resources\views/admin/profile/view.blade.php ENDPATH**/ ?>