                ...
                <div class="container-fluid py-4">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a onclick="window.location.href='/doctor/patients/all'">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    Patients</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($appointments); ?>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a onclick="window.location.href='/doctor/appointments/all'">
                                            ...
                                            <a href="/doctor/prescriptions">
                                                <div class="text-white d-flex rounded h-100 mask  red darken-4">
                                                    <div class="first-content align-self-center p-3">
                                                        ...
                                                        <p class="">Create a new E-Prescription.View all your
                                                            E-Prescriptions.</p>
                                                    </div>
                                                    <div class="second-content align-self-center mx-auto text-center">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/doctor/dashboard.blade.php ENDPATH**/ ?>