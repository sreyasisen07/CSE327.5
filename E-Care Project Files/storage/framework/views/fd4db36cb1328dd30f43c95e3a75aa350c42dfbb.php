...
<?php $__env->startSection('pagetitle', 'Order'); ?>
                    ...
                    <div class="table-responsive mb-4">
                       <table class="table table-striped table-bordered table-sm small-table" style="text-align:center!important;">
                         ...
                         <tbody>
                           ...
                           <tr>
                             <th class="small-table" scope="row"><?php echo e($order->type); ?></th>
                             <td class="small-table"><?php echo e($order->name); ?></td>
                             <td class="small-table"><?php echo e($order->dosage); ?>Mg/Ml</td>
                             <td class="small-table"><?php echo e($order->status); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/patient/medicines/orders.blade.php ENDPATH**/ ?>