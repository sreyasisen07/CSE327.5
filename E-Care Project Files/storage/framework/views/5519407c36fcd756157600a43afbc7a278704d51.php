...
<?php $__env->startSection('pagetitle', 'Requests'); ?>
                      ...
                      <!-- Content -->
                        ...
                        <div class=" rounded d-flex h-100 mask rgba-cyan-slight" style="padding:20px;">
                          <div class="first-content align-self-center p-3">
                            ...
                            <h5 class="card-title font-weight-bold"><?php echo e($request->patient_name); ?></h5>
                          <p class="mb-0">Age : <?php echo e($request->patient_age); ?></p>
                          <p class="mb-0">Gender : <?php echo e($request->patient_gender); ?></p>
                          <p class="mb-0">Blood Group : <?php echo e($request->patient_blood); ?></p>
                          <p class="">Department : <?php echo e($request->department_name); ?></p>
                            ...
                            <div class="col-md-6 mb-4">
                              <form action="/doctor/appointments/requests" method="POST">
                                  ...
                                  <input type="hidden" name="id" value="<?php echo e($request->id); ?>">
                                    ...
                                    <button type="submit" name="Approve" class="btn btn-dark-green btn-block MyButton" aria-label="Left Align">Approve 
                            ...
                            <div class="col-md-6">
                              <form action="/doctor/appointments/requests" method="POST">
                                  ...
                                  <input type="hidden" name="id" value="<?php echo e($request->id); ?>">
                                    ...
                                    <button type="submit" name="Decline" class="btn btn-danger btn-block MyButton" aria-label="Left Align">Decline 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/doctor/appointments/requests.blade.php ENDPATH**/ ?>