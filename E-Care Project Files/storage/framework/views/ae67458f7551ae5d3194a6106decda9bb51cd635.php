                ...
                <div id="appointment" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class=" py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="\admin\appointment\request"><i
                                ...
                                class="badge badge-danger"><?php echo e($pending); ?></span></a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Pages Collapse Menu -->
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Patients</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($patient); ?></div>
                                            </div>
                                            <div class="col-auto">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>