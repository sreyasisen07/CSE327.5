...
<?php $__env->startSection('pagetitle', 'Add Branch'); ?>
                            ...
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                      <input id="name" placeholder="Branch Name" type="text" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="branch_id" class="form-control  <?php $__errorArgs = ['branch_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Branch ID" name="branch_id" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Parcel-Manager\resources\views/admin/branch/add.blade.php ENDPATH**/ ?>