                ...
                <div class="container-fluid py-4">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a onclick="window.location.href='/patient/doctors/all'">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    Doctors</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($doctor); ?></div>
                                            </div>
                                            <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a onclick="window.location.href='/patient/department/all'">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Departments</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($department); ?>
                    ...
                    <div class="jumbotron jumbotron-fluid"
                        ...
                        <div class="container">
                            ...
                            <p class="lead text-center small">Most popular departments based on patient's appointment
                                requests</p>
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    <!-- Card -->
                            ...
                            <div class="row justify-content-center">
                                ...
                                <a href="/patient/department/all" class="text-danger d-flex flex-row-reverse p-2">
                                    <h5 class="waves-effect waves-light font-weight-bold">View more<i
                                            class="fas fa-angle-double-right ml-2"></i></h5>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <a href="/services" class="text-danger d-flex flex-row-reverse p-2">
                                    <h5 class="waves-effect waves-light font-weight-bold">More Services<i
                                            class="fas fa-angle-double-right ml-2"></i></h5>
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/patient/dashboard.blade.php ENDPATH**/ ?>