                                    ...
                                    <div class="card-header font-weight-bold">
                                        <div class="row justify-content-center">
                                            <span class=" mdb-color-text font-weight-bold small">Request time :
                                                <?php echo e($appointment->created_at); ?></span>
                                        </div>
                                        ...
                                        <div class="row justify-content-center mb-4">
                                            <div class="col-md-6">
                                                ...
                                                <div class="small">
                                                    ...
                                                    </span><span><?php echo e($appointment->doctor_name); ?></span><br>
                                                    <span class="font-weight-bold"> Designation :
                                                    </span><span><?php echo e($appointment->doctor_designation); ?></span><br>
                                                    <span class="font-weight-bold"> Department :
                                                    </span><span><?php echo e($appointment->department_name); ?></span><br>
                                                    <span class="font-weight-bold"> Gender :
                                                    </span><span><?php echo e($appointment->doctor_gender); ?></span>
                                                    <hr>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="small">
                                                    ...
                                                    </span><span><?php echo e($appointment->patient_name); ?></span><br>
                                                    <span class="font-weight-bold"> Age :
                                                    </span><span><?php echo e($appointment->patient_age); ?></span><br>
                                                    <span class="font-weight-bold"> Gender :
                                                    </span><span><?php echo e($appointment->patient_gender); ?></span><br>
                                                    <span class="font-weight-bold"> Blood Group :
                                                    </span><span><?php echo e($appointment->patient_blood); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/admin/appointment/view.blade.php ENDPATH**/ ?>