...
<?php $__env->startSection('pagetitle', 'Add Doctor'); ?>
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group row">
                                  <label for="reg_no" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Registration No.')); ?></label>
      
                                  <div class="col-md-6">
                                      <input id="reg_no" type="number" class="form-control <?php $__errorArgs = ['reg_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="reg_no" value="<?php echo e(old('reg_no')); ?>" autocomplete="reg_no">
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                  <select name="designation" class="form-control  <?php $__errorArgs = ['designation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                  <select name="department" class="form-control  <?php $__errorArgs = ['department'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="degree" placeholder="Separated by comma" value="<?php echo e(old('degree')); ?>"autocomplete="degree">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/admin/doctor/add.blade.php ENDPATH**/ ?>