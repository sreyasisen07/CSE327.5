        ...
        <div class="card mb-4">
          ...
          <div class="card-body branch_add">
            ...
            <div class="row justify-content-start mb-4">
              <div class="col">
                <span  class="font-weight-bold"> Status : </span><span style="background-color:#c8e6c9; color:#1b5e20;padding:0.5%;"><?php echo e($appointment->status); ?></span><br>
              ...
              <div class="col-md-8">
                  <div class="row justify-content-end">
                    ...
                    <form action="/doctor/appointments/conversation" method="GET">
                     ...
                     <input type="hidden" name="id" value="<?php echo e($appointment->id); ?>">
                     <input type="hidden" name="patient_name" value="<?php echo e($appointment->patient_name); ?>">
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/doctor/appointments/view.blade.php ENDPATH**/ ?>