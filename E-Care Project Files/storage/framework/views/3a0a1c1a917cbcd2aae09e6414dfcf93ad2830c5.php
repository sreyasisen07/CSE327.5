                                        ...
                                        <div class="card gradient-card">
                                            ...
                                            <div class="blue-grey-text d-flex h-100 mask cloudy-knoxville-gradient">
                                                <div class="first-content align-self-center p-3"
                                                    ...
                                                    <h5 class="lead mb-0 font-weight-bold">
                        ...
                        <div class="container">
                            <div id="accordion">
                                <div class="card Poppins">
                                    ...
                                    <div class="card-body">
                                        <form role="form" action="/admin/profile/view" method="POST"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input
                                                        ...
                                                        value=<?php echo e(Auth::guard('admin')->user()->email); ?>>
                                            ...
                                            <div class="form-group row">
                                                <label
                                                    class="col-lg-3 col-form-label form-control-label text-danger font-weight-bold">Account
                                                    Password</label>
                                                <div class="col-lg-6">
                                                    <input
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="hidden" name="id"
                                                        value="<?php echo e(Auth::guard('admin')->user()->id); ?>" />
                                                    <input type="submit" class="btn btn-dark-green Mybutton"
                                                        value="Save">
                                                </div>
                                        </form>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/admin/profile/view.blade.php ENDPATH**/ ?>