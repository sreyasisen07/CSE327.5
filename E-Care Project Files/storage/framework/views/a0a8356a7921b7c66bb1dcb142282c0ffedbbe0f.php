                      ...
                      <div class="card-body">
                           <form role="form" action="/admin/profile/password" method="POST" style="padding-left:15%;padding-top:3%;">
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-lg-6">
                                      <input class="form-control  <?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>"  name="password" type="password" id="newpassword">
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Parcel-Manager\resources\views/admin/profile/password.blade.php ENDPATH**/ ?>