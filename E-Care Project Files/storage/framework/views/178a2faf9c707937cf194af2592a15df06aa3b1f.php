     ...
     <div id="content">
       ...
       <div class="container-fluid py-4">
        <div class="jumbotron jumbotron-fluid" style="padding-top:20px!important;padding-bottom:20px!important;">
            <div class="container">
            <h4 class="text-center">Department : <?php echo e($department); ?></h4>
                      ...
                      <!-- Content -->
                        ...
                        <div class=" rounded d-flex h-100 mask rgba-cyan-slight" style="padding:20px;">
                          <div class="first-content align-self-center p-3">
                            ...
                            <h5 class="card-title font-weight-bold">Dr. <?php echo e($doctor->name); ?></h5>
                          <p class="mb-0"><?php echo e($doctor->designation); ?> of <?php echo e($doctor->department); ?></p>
                          <p class="mb-0"><?php echo e($doctor->degree); ?></p>
                          <p class="mb-0">BMDC REG No. : <?php echo e($doctor->reg_no); ?></p>
                          <p class="">Gender : <?php echo e($doctor->gender); ?></p>
                            ...
                            <form action="/patient/department/doctors" method="POST">
                              ...
                              <input type="hidden" name="doctor_name" value="<?php echo e($doctor->name); ?>">
                              <input type="hidden" name="doctor_designation" value="<?php echo e($doctor->designation); ?>">
                              <input type="hidden" name="doctor_gender" value="<?php echo e($doctor->gender); ?>">
                              <input type="hidden" name="doctor_reg" value="<?php echo e($doctor->reg_no); ?>">
                              <input type="hidden" name="department_name" value="<?php echo e($doctor->department); ?>">
                              <input type="hidden" name="doctor_degree" value="<?php echo e($doctor->degree); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/patient/department/doctors.blade.php ENDPATH**/ ?>