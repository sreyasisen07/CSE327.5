...
<?php $__env->startSection('pagetitle', 'Confirm Appointment'); ?>
                    ...
                    <div class="card-header font-weight-bold"></div>
                      <div class="card-body branch_add">
                        ...
                        <div class="row mb-4">
                          ...
                          <span>Appointment ID :</span><span class="mdb-color-text" style="font-weight:bold;"> &nbsp;<?php echo e($appointment_id); ?></span>
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="barcode">
                            ...
                            <?php echo DNS1D::getBarcodeHTML($appointment_id, "C128",1.4,22); ?>

                            <p class="small text-center"><?php echo e($appointment_id); ?></p>
                        </div>
                        </div>
                        <hr>
                        <div class="row justify-content-center mb-4">
                          <div class="col-md-6">
                            ...
                            <span class="font-weight-bold"> Doctor Name : </span><span>Dr. <?php echo e($doctor_name); ?></span><br>
                            <span class="font-weight-bold"> Designation : </span><span><?php echo e($doctor_designation); ?></span><br>
                            <span class="font-weight-bold"> Degree : </span><span><?php echo e($doctor_degree); ?></span><br>
                            <span class="font-weight-bold"> BMDC REG No. : </span><span><?php echo e($doctor_reg); ?></span><br>
                            <span class="font-weight-bold"> Gender : </span><span><?php echo e($doctor_gender); ?></span>
                            <hr>
                            </div>
                          </div>
                          <div class="col-md-6">
                            ...
                            <div class="small">
                              <span class="font-weight-bold"> Patient Name : </span><span><?php echo e(Auth::guard('patient')->user()->name); ?></span><br>
                              <span class="font-weight-bold"> Department : </span><span><?php echo e($department_name); ?></span><br>
                              <span class="font-weight-bold"> Age : </span><span><?php echo e(Auth::guard('patient')->user()->age); ?> Years</span><br>
                              <span class="font-weight-bold"> Gender : </span><span><?php echo e(Auth::guard('patient')->user()->gender); ?></span><br>
                              <span class="font-weight-bold"> Blood Group : </span><span><?php echo e(Auth::guard('patient')->user()->blood); ?></span><br>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="">
                                ...
                                <form action="/patient/appointments/confirm" method="GET">
                                  ...
                                  <input type="hidden" name="doctor_name" value="<?php echo e($doctor_name); ?>">
                                  <input type="hidden" name="doctor_designation" value="<?php echo e($doctor_designation); ?>">
                                  <input type="hidden" name="doctor_gender" value="<?php echo e($doctor_gender); ?>">
                                  <input type="hidden" name="department_name" value="<?php echo e($department_name); ?>">
                                  <input type="hidden" name="patient_id" value="<?php echo e(Auth::guard('patient')->user()->id); ?>">
                                  <input type="hidden" name="patient_name" value="<?php echo e(Auth::guard('patient')->user()->name); ?>">
                                  <input type="hidden" name="patient_age" value="<?php echo e(Auth::guard('patient')->user()->age); ?>">
                                  <input type="hidden" name="patient_gender" value="<?php echo e(Auth::guard('patient')->user()->gender); ?>">
                                  <input type="hidden" name="patient_blood" value="<?php echo e(Auth::guard('patient')->user()->blood); ?>">
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/patient/appointments/confirm.blade.php ENDPATH**/ ?>