...
<?php $__env->startSection('pagetitle', 'Patient Login'); ?>
        ...
        <div class="col-md-9">
            <div class="jumbotron" style="padding-top:10%;padding-bottom:10%; margin-bottom:0px;">
                ...
                <div class="row justify-content-center" style="margin-bottom:1%;">
                    <i class=" mdb-color-text fas fa-hospital-user fa-3x text-center"></i>
                </div>
                <div class="row justify-content-center" style="margin-bottom:5%;">
                    <h4 class="mdb-color-text">Patient Login</h4>
                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-5">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <a class="btn btn-link font-weight-bold"
                                    href="<?php echo e(route('password.request')); ?>"><small>
                    ...
                    <div class="form-group row justify-content-center">
                        <div class="col-md-5">
                            <a style="font-size:10px!important;"
                                class="btn btn-sm btn-block btn-blue-grey text-white  waves-effect"
                                onclick="window.location.href='/auth/google'"><img
                                    src="https://img.icons8.com/color/16/000000/google-logo.png"> &nbsp;&nbsp;Sign in
                                with Google&nbsp;&nbsp;</a>
                        </div>
                    ...
                    <div class="form-group row justify-content-center">
                        <div class="col-md-5">
                            <a style="font-size:10px!important;" class="btn btn-sm btn-block  btn-indigo waves-effect"
                                onclick="window.location.href='/auth/linkedin'"><img
                                    src=https://img.icons8.com/fluent/16/000000/linkedin.png> &nbsp;&nbsp;Sign in with
                                Linkedin</a>
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Care\resources\views/patient/login.blade.php ENDPATH**/ ?>