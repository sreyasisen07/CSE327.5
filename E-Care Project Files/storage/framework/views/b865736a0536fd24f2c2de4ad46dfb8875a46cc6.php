                    ...
                    <div class="card Poppins">
                        ...
                        <div class="card Poppins mb-4">
                            ...
                            <div class="card-body" style="padding:7%;">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6 parcel">
                                        <span class="font-weight-bold">Status : </span><span style="background-color:#c8e6c9; color:#1b5e20;padding:0.5%;" class="font-weight-bold small">&nbsp;&nbsp; <?php echo e($shipment->status); ?> &nbsp;&nbsp;</span>
                                    </div>
                                    <div class="col-md-6 parcel">
                                ...
                                <div class="row justify-content-end">
                                    ...
                                    <div class="col-md-3">
                                        <button class="btn btn-unique btn-sm">Cancel Request</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Parcel-Manager\resources\views/customer/parcel/parcels.blade.php ENDPATH**/ ?>