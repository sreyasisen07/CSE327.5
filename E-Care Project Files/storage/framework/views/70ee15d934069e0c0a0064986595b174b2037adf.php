      ...
      <li class="nav-item">
        ...
        <div id="Shipment" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class=" py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="\admin\shipment\request"><i class="fas fa-truck-pickup"></i> &nbsp;Pickup Requests <span class="badge badge-danger"><?php echo e($pending); ?></span></a>
             ...
             <a onclick="window.location.href='/admin/branch/branches'"> <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($branch); ?></div>
                    </div>
                    <div class="col-auto">
             ...
             <a onclick="window.location.href='/admin/customer/customers'"> <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($customer); ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo e($completed); ?></div>
                        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/vendor/Chart.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/chart-bar-demo.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/chart-pie-demo.js')); ?>"></script>
    
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Parcel-Manager\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>